		...
		public override void Up()
		{
			...
			CreateTable(
				...
				c => new
				{
					...
					StandErf = c.String(nullable: false, maxLength: 255, storeType: "nvarchar"),
					Township = c.String(nullable: false, maxLength: 255, storeType: "nvarchar"),
			...
			CreateTable(
				...
				c => new
				{
					...
					LandlordDocumentationTypeEnum = c.String(nullable: false, maxLength: 100, storeType: "nvarchar"),
				})
