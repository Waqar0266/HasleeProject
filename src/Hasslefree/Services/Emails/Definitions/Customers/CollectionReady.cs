...
{
	public class CollectionReady : IEmailDefinition
	{
		public string Title => "Collection Ready";
		...
		public InstallDefinition Install => new InstallDefinition()
		{
			Send = true,
			From = "",
			Subject = "Order ready for collection - {0}",
			Recipient = "",
			Url = "/order/collection-ready-email/?documentId={0}"
		};
	}
}
