...
{
	public class RegisterDeclined : IEmailDefinition
	{
		public string Title => "Registration Declined";
		...
		public InstallDefinition Install => new InstallDefinition()
		{
			Send = true,
			From = "",
			Subject = "Registration Application Declined",
			Recipient = "",
			Url = "/account/register-application-declined"
		};
	}
}
