    ...
    public class CompleteRentalAgentSignatureController : BaseController
    {
        ...
        public ActionResult CompleteAgent(string hash)
        {
            ...
            var model = new CompleteRentalAgent
            {
                ...
                ManagementAmount = rental.RentalMandate?.ManagementAmount ?? (decimal?)null,
                ManagementPercentage = rental.RentalMandate?.ManagementPercentage ?? (decimal?)null,
                ...
                Procurement1Amount = rental.RentalMandate?.Procurement1Amount ?? (decimal?)null,
                Procurement1Percentage = rental.RentalMandate?.Procurement1Percentage ?? (decimal?)null,
                Procurement2Amount = rental.RentalMandate?.Procurement2Amount ?? (decimal?)null,
                Procurement2Percentage = rental.RentalMandate?.Procurement2Percentage ?? (decimal?)null,
                Procurement3Amount = rental.RentalMandate?.Procurement3Amount ?? (decimal?)null,
                Procurement3Percentage = rental.RentalMandate?.Procurement3Percentage ?? (decimal?)null,
                ProvideLandlord = rental.ProvideLandlord,
                Rental = rental.MonthlyRental,
                RentalPaymentDate = rental.MonthlyPaymentDate,
                SaleAmount = rental.RentalMandate?.SaleAmount ?? (decimal?)null,
                SalePercentage = rental.RentalMandate?.SalePercentage ?? (decimal?)null,
